...
class Help(commands.Cog):
    ...
    async def _help(self, interaction: discord.Interaction, command: str):
        ...
        embed = discord.Embed(title=f"Help | {command.name.title()}", description=f"{command.description}", color=0xffffff)
        useage = ""
        query = ""
        ...
        if type(command) == app_commands.commands.Command:
            ...
            embed = discord.Embed(title=f"Help | {command.name}", description=f"{command.description}", color=0xffffff)
            embed.description += f"\n\n**Available Commands:**\n"
            ...
            for sub_command in command.commands:
                sub_cmd_embed = discord.Embed(title=f"{command.name.title()} {sub_command.name}", description=f"{sub_command.description}", color=0xffffff)
                useage = ""
                query = ""
