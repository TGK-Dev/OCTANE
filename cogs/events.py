...
class events(commands.Cog):
	...
	async def on_member_join(self, member):
	   ...
	   embed.add_field(name='Server Support', value='To get in touch with staff, simply raise a ticket fromv :love_letter:[。mod-mail](https://discord.com/channels/785839283847954433/823659390108303410/823667017517105192)', inline=False)
